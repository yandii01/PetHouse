				...
				<div class="container">   
					<div class="agile_header_grid"> 
						<div class="header-mdl agileits-logo"><!-- header-two --> 
							<h1><a href="{{ url('/') }}">ANY's PET HOUSE</a></h1> 
						</div>
						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav cl-effect-16">
									...
									<li><a href="{{ url('/beritas')}}"  data-hover="News">News</a></li> 
									<li><a href="{{ url('/products')}}"  data-hover="Product">Product</a></li>
									<li><a href="{{ url('/hotels')}}" data-hover="Pet House">Pet House</a></li>
		...
		<div class="footer-top">
			<div class="container">
				<div class="footer-grids">
					...
					<div class="col-md-6 col-sm-6 footer-list">
						<h3>Contact Us</h3>
						<ul>
							
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i>UPN "Veteran" Jakarta, Pondok Labu, Jakarta Selatan</li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i> anyspethouse@gmail.com</li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i> +62 8833 2244 556</li>
